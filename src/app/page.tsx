    ...
    <main className="min-h-screen bg-[#0A0B1E] text-white overflow-hidden">
      ...
      <div className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          ...
          {/* Enhanced Subtitle */}
          <p className="mt-8 text-xl text-center text-gray-300 max-w-3xl mx-auto animate-fade-in-up">
            Join the movement of radical health transparency. Track your metrics, share your wins, inspire your community.
          </p>
          <p className="mt-4 text-lg text-center text-indigo-400 font-medium animate-fade-in-up delay-100">
          ...
          <div className="mt-12 flex flex-col sm:flex-row justify-center gap-4 animate-fade-in-up delay-200">
            ...
            <button className="group inline-flex items-center justify-center px-8 py-3 border border-gray-700 text-base font-medium rounded-lg text-gray-300 hover:bg-gray-800 hover:border-gray-600 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-gray-800/25">
              Explore
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-8 animate-fade-in-up delay-300">
            ...
            <div className="group bg-gray-900/50 backdrop-blur rounded-2xl p-6 border border-gray-800 hover:border-indigo-500/50 transition-colors hover:shadow-lg hover:shadow-indigo-500/10">
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in-up delay-400">
            {/* Enhanced Feature 1 */}
            <div className="group bg-gray-900/30 backdrop-blur rounded-xl p-6 border border-gray-800/50 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/10">
