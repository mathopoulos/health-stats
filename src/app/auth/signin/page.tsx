        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="mt-8 space-y-6 animate-fade-in-up delay-100">
            <button
              ...
              className="w-full group bg-gray-900/50 backdrop-blur flex items-center justify-center gap-3 px-6 py-4 rounded-xl border border-gray-800 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/10"
            >
          ...
          {/* Additional Info */}
          <p className="text-center text-sm text-gray-500 animate-fade-in-up delay-200">
